...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        Schema::table('game_skill_definitions', function (Blueprint $table) {
            $columns = ['skill_stage', 'skill_line', 'node_tier', 'spec_branch', 'unlock_level'];
